...
class PartTest {
    ...
    @Test
    void inventoryIsBelowMaxInv() {
        int inv = 50;  // Set inv below maxInv
        int maxInv = 100;
        partIn.setInv(inv);
        partOut.setInv(inv);
        ...
        assertTrue(partIn.getInv() < partIn.getMaxInv());
        assertTrue(partOut.getInv() < partOut.getMaxInv());
    }

    @Test
    void inventoryIsAboveMinInv() {
        int inv = 5;  // Set inv above minInv
        int minInv = 3;
        partIn.setInv(inv);
        partOut.setInv(inv);
        ...
        assertTrue(partIn.getInv() > partIn.getMinInv());
        assertTrue(partOut.getInv() > partOut.getMinInv());
    }
